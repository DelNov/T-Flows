...
#define HDF5_INCLUDE_PATH "Hdf5_Par_Openmpi/include"
#define HDF5_LIBRARY      "Hdf5_Par_Openmpi/lib/libhdf5.a"

#define HDF5_NEED_MPI     1
#define HDF5_NEED_SZIP    0
#define HDF5_NEED_ZLIB    0

#define MPI_INCLUDE_PATH "Openmpi/include"
#define MPI_LIBRARY      "-LOpenmpi/lib -l "
#define SZIP_LIBRARY     ""
#define ZLIB_LIBRARY     ""

#define MPI_INC          "Openmpi/include"
#define MPI_LIBS         "-LOpenmpi/lib -l "
