...
!==============================================================================!
  ...
  call Backup_Mod_Write_Real(fh, d, 'bulk_flux_x',   bulk(1) % flux_x)
  call Backup_Mod_Write_Real(fh, d, 'bulk_flux_y',   bulk(1) % flux_y)
  call Backup_Mod_Write_Real(fh, d, 'bulk_flux_z',   bulk(1) % flux_z)
  call Backup_Mod_Write_Real(fh, d, 'bulk_p_drop_x', bulk(1) % p_drop_x)
  call Backup_Mod_Write_Real(fh, d, 'bulk_p_drop_y', bulk(1) % p_drop_y)
  call Backup_Mod_Write_Real(fh, d, 'bulk_p_drop_z', bulk(1) % p_drop_z)
