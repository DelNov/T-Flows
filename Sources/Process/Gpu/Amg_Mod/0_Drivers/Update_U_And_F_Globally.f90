!==============================================================================!
  subroutine Update_U_And_F_Globally(Amg, level, vec_u, vec_u_b,  &
                                                 vec_f, vec_f_b,  &
                                                 for_real)
!------------------------------------------------------------------------------!
  implicit none
...
!==============================================================================!
  ...
  if(present(vec_u_b)) then
    do i = Amg % imin(level), Amg % imax(level)
      i_loc = i - Amg % imin(level) + 1
      vec_u_b(i) = Amg % lev(level) % u_b(i_loc)
    end do
  end if
  ...
  if(present(vec_f_b)) then
    do i = Amg % imin(level), Amg % imax(level)
      i_loc = i - Amg % imin(level) + 1
      vec_f_b(i) = Amg % lev(level) % f_b(i_loc)
    end do
  end if
