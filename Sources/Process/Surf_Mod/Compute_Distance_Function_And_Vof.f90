!==============================================================================!
  subroutine Surf_Mod_Compute_Distance_Function_And_Vof(surf, cell_dist, vof)
!------------------------------------------------------------------------------!
...
!==============================================================================!
  ...
  do v = 1, nv
    ...
    ! Take nearest cell
    d = surf % vert(v) % cell  ! nearest cell
    ...
    do i_ele = 1, surf % vert(v) % nne
      e  = surf % vert(v) % vert_e(i_ele)
