...
1 continue
  ...
  if(First_Proc()) then
    ...
    print '(a)', trim(line)
    line( 1:160) = ' '
    line( 1+indent:38+indent) = '#                        Total time:  '
    ...
    write(line(38+indent:40+indent), '(i3.3)')  hours
    write(line(41+indent:41+indent),   '(a1)')  ':'
    write(line(42+indent:43+indent), '(i2.2)')  minutes  ! <- check!
    write(line(44+indent:44+indent),   '(a1)')  ':'
    write(line(45+indent:46+indent), '(i2.2)')  seconds
    write(line(48+indent:58+indent),  '(a11)') '[hhh:mm:ss]'
    ...
    print '(a)', trim(line)
    line( 1+indent:83+indent) =  &
         '#        Description of the activity:         |            Spent '// &
         'time:            #'
    print '(a)', trim(line)
    line( 1+indent:83+indent) =   &
         '#---------------------------------------------+-----------------+'// &
