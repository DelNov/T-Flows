!==============================================================================!
  subroutine Safe_Connect_Real_Cell(Work,                                    &
...
!==============================================================================!
  ...
  if(.not. allocated(Work % r_cell(Work % last_r_cell) % array))  &
    call Work % Allocate_Real_Cell(Work % last_r_cell)
