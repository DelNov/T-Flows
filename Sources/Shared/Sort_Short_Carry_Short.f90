!==============================================================================!
      subroutine Sort_Short_Carry_Short(x, y, n, kflag)
!------------------------------------------------------------------------------!
...
!==============================================================================!
      ...
      nn = n
      if (nn.ge.1) goto 10
      print *, 'Sort_Short_Carry_Short: the number of values to be ' // &
               'sorted was not positive.'
      return
   10 kk = iabs(kflag)
      if ((kk.eq.1).or.(kk.eq.2)) goto 15
      print *, 'Sort_Short_Carry_Short: the sort control parameter, ' // &
