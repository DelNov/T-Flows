!==============================================================================!
  pure recursive subroutine Three_Real_Carry_Two_Int(Sort, a1, a2, a3, b, c)
!------------------------------------------------------------------------------!
...
!==============================================================================!
  ...
  if(1 < i - 1) call Sort % Three_Real_Carry_Two_Int(a1(1:i-1),  &
                                                     a2(1:i-1),  &
                                                     a3(1:i-1),  &
                                                     b (1:i-1),  &
                                                     c (1:i-1))
  if(j + 1 < n) call Sort % Three_Real_Carry_Two_Int(a1(j+1:n),  &
                                                     a2(j+1:n),  &
                                                     a3(j+1:n),  &
                                                     b (j+1:n),  &
                                                     c (j+1:n))
