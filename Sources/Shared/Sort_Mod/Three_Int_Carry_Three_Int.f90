!==============================================================================!
  recursive subroutine Three_Int_Carry_Three_Int(Sort, a1, a2, a3, b, c, d)
!------------------------------------------------------------------------------!
...
!==============================================================================!
  ...
  if(1 < i - 1) call Sort % Three_Int_Carry_Three_Int(a1(1:i-1),  &
                                                      a2(1:i-1),  &
                                                      a3(1:i-1),  &
                                                      b (1:i-1),  &
                                                      c (1:i-1),  &
                                                      d (1:i-1))
  if(j + 1 < n) call Sort % Three_Int_Carry_Three_Int(a1(j+1:n),  &
                                                      a2(j+1:n),  &
                                                      a3(j+1:n),  &
                                                      b (j+1:n),  &
                                                      c (j+1:n),  &
