...
!==============================================================================!
  ...
  call Sort_Mod_Real_By_Index(grid % sx(1), new_f(1), grid % n_faces)
  call Sort_Mod_Real_By_Index(grid % sy(1), new_f(1), grid % n_faces)
  call Sort_Mod_Real_By_Index(grid % sz(1), new_f(1), grid % n_faces)
