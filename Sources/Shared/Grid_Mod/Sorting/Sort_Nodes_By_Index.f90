!==============================================================================!
  subroutine Sort_Nodes_By_Index(Grid, indx)
!------------------------------------------------------------------------------!
...
!---------------------------------[Arguments]----------------------------------!
  ...
  integer                         :: indx(Grid % n_nodes)  !! index array
!-----------------------------------[Locals]-----------------------------------!
  integer :: s, c, n, i_nod
!==============================================================================!
  ...
  if(Math % Approx_Real(maxval(Grid % xn(:)), 0.0) .and.  &
    ...
    call Message % Error(64,                                                   &
              'You called the function Grid % Sort_Nodes_By_Index '        //  &
  ...
  !--------------------------------------------------!
  call Sort % Int_Carry_Int(indx, Grid % old_n(1:Grid % n_nodes))
