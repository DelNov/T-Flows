!==============================================================================!
  subroutine Blending_Coefficients_For_Scalars(Control, val, verbose)
!------------------------------------------------------------------------------!
...
!==============================================================================!
  ...
  call Control % Read_Real_Vector('BLENDING_COEFFICIENTS_FOR_SCALARS',  &
                                  3, def, val, verbose)
  ...
  if( .not. Math % Approx_Real(sum(val(1:3)), 1.0) ) then
    ...
    call Message % Error(64,                                         &
                         ...
                         'must be equal to 1.0.  For scalar '    //  &
                         'equation it is '//numb//'! '           //  &
