!==============================================================================!
  subroutine Sum_Reals(Global, phi_01, phi_02, phi_03, phi_04,  &
...
!---------------------------------[Arguments]----------------------------------!
  ...
  real,             intent(inout) :: phi_01  !! global sum 1
  real, optional,   intent(inout) :: phi_02  !! global sum 2
  real, optional,   intent(inout) :: phi_03  !! global sum 3
  real, optional,   intent(inout) :: phi_04  !! global sum 4
  real, optional,   intent(inout) :: phi_05  !! global sum 5
  real, optional,   intent(inout) :: phi_06  !! global sum 6
  real, optional,   intent(inout) :: phi_07  !! global sum 7
...
!==============================================================================!
  ...
  call Global % Sum_Real_Array(n, phi(1:n))
