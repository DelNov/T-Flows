...
!------------------------------------------------------------------------------!
!>  The subroutine Sum_Int_Array in a parallel computing framework calculates
!>  the global sum of integer arrays across all processors. This subroutine is
!>  vital in scenarios where an aggregate sum of distributed integer values is
