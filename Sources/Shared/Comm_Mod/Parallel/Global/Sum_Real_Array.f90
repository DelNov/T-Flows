...
!------------------------------------------------------------------------------!
!>  The subroutine Sum_Real_Array in a parallel computing framework calculates
!>  the global sum of real arrays across all processors. This subroutine is
!>  vital in scenarios where an aggregate sum of distributed real values is
