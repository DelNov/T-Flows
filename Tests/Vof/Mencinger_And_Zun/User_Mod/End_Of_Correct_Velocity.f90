...
!-----------------------------------[Locals]-----------------------------------!
  ...
  integer                    :: c, s
  character(30)              :: fil1_name = 'correct_velocity_xxxxx_yyy.dat'
  character(30)              :: fil2_name = 'correct_v_vluxes_xxxxx_yyy.dat'
!==============================================================================!
  ...
  !---------------------------------------------------!
  write(fil1_name(18:22), '(i5.5)') curr_dt
  write(fil1_name(24:26), '(i3.3)') ini
  ...
  !---------------------------------------------------!
  write(fil2_name(18:22), '(i5.5)') curr_dt
  write(fil2_name(24:26), '(i3.3)') ini
