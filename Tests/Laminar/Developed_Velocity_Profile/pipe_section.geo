...
N_CORE                 =  10;      // number of nodes in the radial direction inside the core (1.5 mm)
N_MIDDLE               =  12;      // number of nodes in the radial direction inside the middle layer (1 mm)
N_BLAYER               =   7;      // number of nodes in the radial direction inside the boundary layer (0.33 mm)
N_STREAM               =  11;      // number of nodes in the inlet stream-wise direction 
N_ARC                  =  10;      // number of nodes in the arches and ellipses (2 mm, 3.57 mm, 3.86 mm, 4.64 mm | 3.93 mm) 
...
Physical Surface("INLET")  = { coreRad_sur_start   : coreRad_sur_start   + side/2 - 1,
                               ...
                               coreRad_sur_start   + side/2 : coreRad_sur_start   + 2*side/2 - 1,
