...
//
// (See figure concave.fig)
//
//------------------------------------------------
L =  5;    // length of the computational domain
H =  1.5;  // height of the computational domain
S =  0.8;  // spacer width
T =  0.6;  // thinner spacer dimension
R =  0.7;  // curvature of the spacer side walls

NH_HALF = 20;  // number of cells along half-height
NS      = 16;  // number of cells covering spacers
...
Point(21) = {X1,  -T,  0,    1.0};
Point(22) = {X1,  -T,  H/2,  1.0};
Point(23) = {X3,  -T,  0,    1.0};
Point(24) = {X3,  -T,  H/2,  1.0};

Point(25) = {X2,  -T,  H/4,  1.0};
Point(26) = {X4,  -T,  H/4,  1.0};

Line(33) = {23, 21};
Circle(34) = {23, 26, 24};
Line(35) = {24, 22};
Circle(36) = {21, 25, 22};
Recursive Delete {Point{25}; Point{26};}

Point(25) = {-T,  X1,  H/2,  1.0};
Point(26) = {-T,  X1,  H,    1.0};
Point(27) = {-T,  X3,  H/2,  1.0};
Point(28) = {-T,  X3,  H,    1.0};

Point(29) = {-T,  X2,  3*H/4,  1.0};
Point(30) = {-T,  X4,  3*H/4,  1.0};

Line(37) = {27, 25};
Circle(38) = {27, 30, 28};
Line(39) = {28, 26};
Circle(40) = {25, 29, 26};
Recursive Delete {Point{30}; Point{29};}
...
Curve Loop(66) = {135, -141, -133, -77, -44, -78};  Plane Surface(64) = {66};
Curve Loop(67) = {136, -142, -134, -88, -48, -89};  Plane Surface(65) = {67};
Curve Loop(68) = {137, 143, -139, -98, -35, -81};  Plane Surface(66) = {68};
Curve Loop(69) = {138, 144, -140, -96, -53, -79};  Plane Surface(67) = {69};
...
// Corrections (144 <=> 143)
// bad: Transfinite Surface {219} = {165, 164, 144, 146};
        Transfinite Surface {219} = {165, 164, 143, 146};
// bad: Transfinite Surface {214} = {164, 162, 134, 144};
        Transfinite Surface {214} = {164, 162, 134, 143};
// bad: Transfinite Surface {215} = {134, 30, 33, 144};
        Transfinite Surface {215} = {134, 30, 33, 143};
// bad: Transfinite Surface {183} = {144, 33, 148, 146};
        Transfinite Surface {183} = {143, 33, 148, 146};
// bad: Transfinite Surface {216} = {164, 130, 33, 144};
        Transfinite Surface {216} = {164, 130, 33, 143};
// bad: Transfinite Surface {181} = {143, 96, 147, 145};
        Transfinite Surface {181} = {144, 96, 147, 145};
...
Transfinite Volume{18} = {162, 127, 130, 164, 134, 30, 33, 143};
Transfinite Volume{15} = {109, 157, 158, 117, 24, 142, 152, 25};
Transfinite Volume{19} = {164, 130, 166, 165, 143, 33, 148, 146};
...
Transfinite Volume{11} = {143, 33, 148, 146, 144, 96, 147, 145};
