...
// Points
//--------
 Point(1) = {0.0 * GEOM_SCALE, 0.0 * GEOM_SCALE, -0.20 * GEOM_SCALE};
 Point(2) = {1.0 * GEOM_SCALE, 0.0 * GEOM_SCALE, -0.20 * GEOM_SCALE};
 Point(3) = {0.0 * GEOM_SCALE, 1.0 * GEOM_SCALE, -0.20 * GEOM_SCALE};
 Point(4) = {1.0 * GEOM_SCALE, 1.0 * GEOM_SCALE, -0.20 * GEOM_SCALE};
 Point(5) = {0.0 * GEOM_SCALE, 0.0 * GEOM_SCALE, -0.00 * GEOM_SCALE};
 Point(6) = {1.0 * GEOM_SCALE, 0.0 * GEOM_SCALE, -0.00 * GEOM_SCALE};
 Point(7) = {0.0 * GEOM_SCALE, 1.0 * GEOM_SCALE, -0.00 * GEOM_SCALE};
 Point(8) = {1.0 * GEOM_SCALE, 1.0 * GEOM_SCALE, -0.00 * GEOM_SCALE};
...
Physical Surface("side_walls")  = {SURF_SOUTH, SURF_NORTH};
