...
prog   =  1.00;    // progression for cell clustering
...
Point(3) = {lx,    0,     lz,    1.0};
Point(4) = {0,     0,     lz,    1.0};
Point(5) = {lx/4,  0,     0,     1.0};
Point(6) = {lx,    0,     lz/2,  1.0};
Point(7) = {3*lx/4,  0,     lz,  1.0};
