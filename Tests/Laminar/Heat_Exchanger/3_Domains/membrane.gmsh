...
//--------
 ...
 Point(5) = {0.0, 0.0,  0.01};
 Point(6) = {1.0, 0.0,  0.01};
 Point(7) = {0.0, 1.0,  0.01};
...
Physical Surface("symmetry")    = {SURF_WEST, SURF_EAST, SURF_SOUTH, SURF_NORTH};

Physical Volume("membrane") = {26};
