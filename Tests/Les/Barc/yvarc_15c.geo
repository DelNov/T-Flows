...
//Refinement 1
//Point(5) = {-10, -6.5, 0, 1.0};
//+
//Point(6) = {35, -6.5, 0, 1.0};
//+
//Point(7) = {35, 5.5, 0, 1.0};
//+
//Point(8) = {-10, 5.5, 0, 1.0};
...
//Point(9) = {-5, -3.5, 0, 1.0};
//+
//Point(10) = {15, -3.5, 0, 1.0};
//+
//Point(11) = {15, 2.5, 0, 1.0};
//+
//Point(12) = {-5, 2.5, 0, 1.0};
...
//Transfinite Curve {1} = 27; //Outer
//Transfinite Curve {73:84} = 14; //Inner
...
//Transfinite Curve {3, 9, 15, 21, 27, 33} = 42 Using Progression 1.1;
